...
type CustomerQueryUsecase interface {
	...
	FindByEmail(ctx context.Context, email string) (entity.Customer, interface{}, error)
	...
	FindByCustId(ctx context.Context, custID string) (entity.Customer, interface{}, error)
}
