...
type EnvelopePaymentGateway struct {
	MainEnvelope
	SuccessTransaction []PaymentGatewayResponse       `json:"success_transaction"`
	FailedTransaction  []PaymentGatewayFailedResponse `json:"failed_transaction"`
}
